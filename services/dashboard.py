...
def app():
    ...
    st.header(
        '¡Bienvenido! Aqui podrá consultar todos los PowerBI usados en los análisis de forma sencilla')
    # Se crea un menu con el nombre de los distintos dashboards
   ...
   # Se llama a la funcion selectbox el cual permite hacer un desplegable con la lista de dashboards
    choice = st.selectbox(
